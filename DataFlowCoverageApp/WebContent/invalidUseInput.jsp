...
<title>Invalid Uses Input</title>
</head>
<body>
...
<table id="tableResult" border="0" width="100%" cellspacing="0" cellpadding="0">
  <tbody><tr><td width="50%" valign="top">    <font face="Garamond">The input graph is invalid because:<br>
    <font color="red">
    <b>Could not understand the format of the uses. Please check the syntax: a variable name followed by a space-separated sequence of nodes or edges where the varialbes are defined.
