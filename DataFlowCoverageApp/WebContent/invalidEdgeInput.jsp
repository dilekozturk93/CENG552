...
<title>Invalid Edge Input</title>
</head>
<body>
...
<table id="tableResult" border="0" width="100%" cellspacing="0" cellpadding="0">
  <tbody><tr><td width="50%" valign="top">    <font face="Garamond">The input graph is invalid because:<br>
    <font color="red">
    <b>Invalid edge input. Please read the notes above the forms. <br> Cannot generate a set of test paths to satisfy the coverage</b>
    </font>
    </font>
    <br>
</td></tr>
